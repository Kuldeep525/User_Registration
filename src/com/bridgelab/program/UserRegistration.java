...
public class UserRegistration {
	...
	public boolean firstName(String name) {
		...
		if(correct) {
			...
			throw new Exception("Please enter correct last name");
		}
		}catch(Exception e ) {
	...
	public boolean lastName(String name) {
		...
		if(correct) {
			...
			throw new Exception("Pls enter correct last name");
		}
		}catch(Exception e ) {
			System.out.println(e.getMessage());
		}
	...
	public boolean emailId(String email) {
		...
		if(correct) {
			...
			throw new Exception("Pls  enter valid email ");
		}
		}catch(Exception e) {
			System.out.println(e.getMessage());
		}
	...
	public boolean mobileNumber(String number) {
		...
		if(correct) {
			...
			throw new Exception("Pls  enter valid number");
		}
		}catch(Exception e) {
			System.out.println(e.getMessage());
		}
	...
	public boolean passwordCase1(String password) {    //create 8 digit password
		...
		if(correct) {
			...
			throw new Exception("Pls  enter valid password");
		}
		}catch(Exception e) {
			System.out.println(e.getMessage());
		}
